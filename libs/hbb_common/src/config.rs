...
pub const RENDEZVOUS_SERVERS: &[&str] = &["desk.iqcym.cn"];
pub const PUBLIC_RS_PUB_KEY: &str = "5pjSWcFBATOzIVSTHveOOdLSIaijaiYxpbEczLVSRFw=";
...
pub const RENDEZVOUS_PORT: i32 = 9101;
pub const RELAY_PORT: i32 = 9102;
